...
export class FormUserPreferenceComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.form = this.fb.group({
      ...
      maxDestinationPerDay: [
        this.userPreference.maxDestinationPerDay,
        Validators.required,
      ],
  ...
  get earliestStart() {
    return this.form.get("earliestStart");
  }
  get latestArrival() {
    return this.form.get("latestArrival");
  }
  get waitingTime() {
    return this.form.get("waitingTime");
  }
  get maxDestinationPerDay() {
    return this.form.get("maxDestinationPerDay");
  }
  get locationName() {

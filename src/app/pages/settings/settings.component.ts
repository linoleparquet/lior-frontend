...
export class SettingsComponent implements OnInit {
  ...
  constructor(private userPreferenceSerice: UserPreferenceService, 
  ...
  update(userPreference: userPreference) {
    this.userPreferenceSerice.putUpdateOneUserPreference(userPreference).subscribe(() => console.log('this.location.back()'))
  }
